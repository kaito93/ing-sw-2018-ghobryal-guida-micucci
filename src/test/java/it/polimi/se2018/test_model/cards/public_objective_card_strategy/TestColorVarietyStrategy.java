 ...
 */
public class TestColorVarietyStrategy extends TestCase {
    private Map map;
    private Card card;
    private Game game;
    private List<Map> maps;
    private Dice g6, y5, b1, p1, r2, g1, r3, y6, p5, b2;

    /**
     * Class Constructor
     * @param name test method name
     */
    public TestColorVarietyStrategy(String name){
        super(name);
    }
    ...
    protected void setUp() throws Exception{
        ...
        card = new PublicObjectiveCard("Color Diagonals", "Test", 5, new ColorVarietyStrategy());
        g6 = new Dice();
