...
public abstract class ConnectionServer implements Cloneable {
    ...
    /**
     * abstract method that close the connection between server and client
     */
    public abstract void closeConnection();

    /**
     * method to clone a connection
    ...
    /**
     * method that returns if the connection is active
     * @return a boolean
     */
    ...
    /**
     * method that set the status of connection
